...
draw(shift(4, 2.309333, 3.2)*scale3(2)*unitsphere, cyan);
draw(shift(2, 5.773333, 3.2)*scale3(2)*unitsphere, cyan);
draw(shift(0, 2.309333, 3.2)*scale3(2)*unitsphere, cyan);
